...
Import-Module "$($PSScriptRoot)\Character.psm1"
Import-Module "$($PSScriptRoot)\WindowMethods.psm1"
Import-Module "$($PSScriptRoot)\Menu.psm1"
Import-Module "$($PSScriptRoot)\WordWrap.psm1"
...
function Show-StartingMessages {
    ...
    Write-Output "`nPowerShell version written by Daniel Kill aka YourWishIsMine"
    Write-Output "Modified: 2020-09-15 by Daniel Kill"
    ...
    # Modified: 2020-09-15 by Daniel Kill
